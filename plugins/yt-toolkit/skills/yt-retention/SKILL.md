...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/skills/yt-retention/scripts/retention.py" retention.csv --duration 600
python3 "${CLAUDE_PLUGIN_ROOT}/skills/yt-retention/scripts/retention.py" retention.csv --transcript transcript.srt
```
