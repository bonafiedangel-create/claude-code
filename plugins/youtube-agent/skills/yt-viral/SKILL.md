...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/skills/yt-viral/scripts/swipe.py" collected.json --min 2.0
```
...
[the 21 formulas](../../lib/hooks.json) - it is not a claim about why the video worked, and you
