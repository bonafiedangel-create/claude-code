...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/skills/yt-package/scripts/title.py" --title "..." --thumb "AI RAN IT"
python3 "${CLAUDE_PLUGIN_ROOT}/skills/yt-package/scripts/title.py" titles.txt            # one per line, ranked
```
