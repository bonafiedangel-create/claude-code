...
The formula comes from lib/hooks.json (the same 21-formula library /yt-script scores hooks against),
matched against the TITLE. It is a judgement about the words on screen, not a claim about why the
video worked.
"""
